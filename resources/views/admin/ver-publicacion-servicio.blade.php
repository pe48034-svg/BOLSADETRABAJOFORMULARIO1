...
<h2 class="fw-bold mb-4">Ver Publicación de Servicio</h2>

<div class="mb-4">
    <a href="{{ url('/admin/publicaciones-servicios') }}" class="btn btn-secondary">Volver a publicaciones</a>
</div>
    ...
    <div class="card-body">
        <div class="row mb-3">
            ...
            <div class="col-md-4 text-md-end">
                <span class="badge {{ $servicio->estado === 'Desactivado' ? 'bg-secondary' : 'bg-success' }} text-white px-3 py-2">
                    {{ $servicio->estado }}
                </span>
                <p class="mb-1"><strong>Publicado:</strong> {{ $servicio->fecha_publicacion }}</p>
                <p class="mb-1"><strong>Inicio:</strong> {{ $servicio->fecha_inicio }}</p>
                <p class="mb-0"><strong>Fin:</strong> {{ $servicio->fecha_fin }}</p>
            </div>
        </div>
