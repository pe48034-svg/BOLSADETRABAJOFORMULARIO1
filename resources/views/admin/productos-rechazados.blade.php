            ...
            <tbody>
                @foreach($productos as $producto)
                    <tr>
                        ...
                        <td>
                            <form method="POST" action="{{ url('admin/productos/restaurar/' . $producto->id_rechazado) }}" style="display:inline;">
                                @csrf
                                <button type="submit" class="btn btn-sm btn-warning" onclick="return confirm('¿Restaurar este producto?')">
                                    Restaurar
                                </button>
                            </form>
                        </td>
