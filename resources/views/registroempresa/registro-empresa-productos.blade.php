                    ...
                    <div id="formEmpresa" class="form-section">
                        ...
                        <div class="row-custom">
                            ...
                            <div class="form-group-custom">
                                ...
                                <input type="text" name="ruc" class="form-control-custom" style="width: 100%;" maxlength="11" pattern="\d{11}" title="Ingrese 11 dígitos de RUC" required placeholder="Ej: 12345678901">
                            ...
                            <div class="form-group-custom">
                                <label class="form-label-custom">👤 Responsable Representante <span style="color: #e74c3c;">*</span></label>
                            ...
                            <div class="form-group-custom">
                                ...
                                <input type="text" name="direccion" class="form-control-custom" style="width: 100%;" required placeholder="Calle, número, distrito...">
                            </div>
                            ...
                            <div class="form-group-custom row-full">
                                ...
                                <input type="file" name="documento_validacion" class="form-control-custom" style="width: 100%; padding: 8px 12px;" accept=".pdf" required>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 mb-4">
                        ...
                        <input
                            ...
                            value="{{ old('fecha_fin', \Carbon\Carbon::now()->addMonth()->format('Y-m-d')) }}"
                        ...
                        <small class="text-muted">Por defecto la publicación inicia hoy y termina en un mes. Se puede extender hasta un año.</small>
